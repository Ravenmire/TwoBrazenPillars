 ...
 * good-message.php
 *
 * Display a good message in a nice box. Maybe.
 *
 */

function good_message($message,$mail_it=FALSE,$print_it=FALSE,$print_diag=FALSE) {

    //$message = wordwrap($message, 70, $CRLF, FALSE);

    $file = 'good-message.php';
    include('ec.php');
    ...
    if ($print_it == FALSE) {
        ...
        print('<FIELDSET CLASS="good-message">'.$nl);
        print('    <LEGEND> <B><I>Good message</I></B> </LEGEND>'.$nl);
        //echo($EC.__LINE__.'] $print_it=');var_dump($print_it);echo($NL);
